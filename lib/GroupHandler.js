const {Group, ClientGroup} = require("./groups/Group.js");
const GroupManager = require("./groups/GroupManager.js");
...
class GroupHandler {
    ...
    constructor({redis}){
        ...
        this.redis = redis;
        this.groupManager = new GroupManager({redis, key: GROUP_HANDLER_KEY});
    }
    ...
    getClientInstance(clientId){
        ...
        this.groupManager.get(clientId).then(info => {
