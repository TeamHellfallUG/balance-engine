...
class Server extends EventEmitter {
    ...
    _send(clientId, message){
        ...
        return this._sendPromise(client, message, clientId);
    }
    ...
    _sendList(clientIds, message) {
        ...
        return Promise.all(onServer.map(clients =>
            reflect(this._sendPromise(clients.socket, message, clients.clientId))));
    }
