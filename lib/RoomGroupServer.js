...
class RoomGroupServer extends GroupServer {
    ...
    _checkUdpUpdateIntegrity(content){
    ...
    __handleUdpUpdateState(clientId, content, header){
        ...
        if(!this._checkUdpUpdateIntegrity(content)){
            this.debug("content integrity failed");
            return;
        }

        this.log("received udp state update"); //TODO remove me
