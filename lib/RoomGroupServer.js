...
const IMSG = {
    ...
    END: PREFIX + "END", //emtted by server only //TODO handle end, also emit an "match" "ended" groupId event
...
class RoomGroupServer extends GroupServer {
    ...
    _attachMerkuryListeners(){
        ...
        this._mk.on("match-ended", groupId => {
            ...
            if(this._logic[groupId]){
                this._logic[groupId].end();
                delete this._logic[groupId];
            }
